...
$series = new DataSeries(DataSeries::TYPE_AREACHART, DataSeries::GROUPING_PERCENT_STACKED, range(0, count($dataSeriesValues) - 1), $dataSeriesLabels, $xAxisTickValues, $dataSeriesValues);
