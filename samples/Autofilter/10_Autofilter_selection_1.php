...
foreach ($periods as $period) {
    ...
    $autoFilter->getColumn('D')->setFilterType(Column::AUTOFILTER_FILTERTYPE_FILTER)->createRule()->setRule(Rule::AUTOFILTER_COLUMN_RULE_EQUAL, array('year' => $currentYear, 'month' => $period, 'day' => $endDate))->setRuleType(Rule::AUTOFILTER_RULETYPE_DATEGROUP);
}
