...
// Just to test...
$spreadsheet->getActiveSheet()->unmergeCells('A28:B28');
// Just to test...
// Protect cells
...
$styleThinBlackBorderOutline = array('borders' => array('outline' => array('borderStyle' => Border::BORDER_THIN, 'color' => array('argb' => 'FF000000'))));
...
$styleThickBrownBorderOutline = array('borders' => array('outline' => array('borderStyle' => Border::BORDER_THICK, 'color' => array('argb' => 'FF993300'))));
...
$spreadsheet->getActiveSheet()->getStyle('A3:E3')->applyFromArray(array('font' => array('bold' => true), 'alignment' => array('horizontal' => Alignment::HORIZONTAL_RIGHT), 'borders' => array('top' => array('borderStyle' => Border::BORDER_THIN)), 'fill' => array('fillType' => Fill::FILL_GRADIENT_LINEAR, 'rotation' => 90, 'startColor' => array('argb' => 'FFA0A0A0'), 'endColor' => array('argb' => 'FFFFFFFF'))));
$spreadsheet->getActiveSheet()->getStyle('A3')->applyFromArray(array('alignment' => array('horizontal' => Alignment::HORIZONTAL_LEFT), 'borders' => array('left' => array('borderStyle' => Border::BORDER_THIN))));
$spreadsheet->getActiveSheet()->getStyle('B3')->applyFromArray(array('alignment' => array('horizontal' => Alignment::HORIZONTAL_LEFT)));
$spreadsheet->getActiveSheet()->getStyle('E3')->applyFromArray(array('borders' => array('right' => array('borderStyle' => Border::BORDER_THIN))));
// Unprotect a cell
