            ...
            foreach ($this->getCoordinates(false) as $coordinate) {
                ...
                if ($cell !== null && isset($autoSizes[$this->cellCollection->getCurrentColumn()])) {
                    ...
                    if (!$isMerged || $isMergedButProceed) {
                        ...
                        $autoSizes[$this->cellCollection->getCurrentColumn()] = max((double) $autoSizes[$this->cellCollection->getCurrentColumn()], (double) Shared\Font::calculateColumnWidth($this->getParent()->getCellXfByIndex($cell->getXfIndex())->getFont(), $cellValue, $this->getParent()->getCellXfByIndex($cell->getXfIndex())->getAlignment()->getTextRotation(), $this->getParent()->getDefaultStyle()->getFont()));
                    }
                }
            }
