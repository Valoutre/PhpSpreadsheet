...
class Ods extends BaseReader
{
    ...
    public function canRead($pFilename)
    {
        ...
        if ($zip->open($pFilename) === true) {
            ...
            if ($stat && $stat['size'] <= 255) {
                ...
                $xml = simplexml_load_string($this->securityScan($zip->getFromName('META-INF/manifest.xml')), 'SimpleXMLElement', Settings::getLibXmlLoaderOptions());
    ...
    public function listWorksheetNames($pFilename)
    {
        ...
        $xml = new XMLReader();
        $xml->xml($this->securityScanFile('zip://' . realpath($pFilename) . '#content.xml'), null, Settings::getLibXmlLoaderOptions());
    ...
    public function loadIntoExisting($pFilename, Spreadsheet $spreadsheet)
    {
        ...
        // Meta
        $xml = simplexml_load_string($this->securityScan($zip->getFromName('meta.xml')), 'SimpleXMLElement', Settings::getLibXmlLoaderOptions());
        ...
        $dom->loadXML($this->securityScan($zip->getFromName('content.xml')), Settings::getLibXmlLoaderOptions());
...
');
                                    ...
                                    switch ($type) {
                                        ...
                                        case 'percentage':
                                            ...
                                            $dataValue = (double) $cellData->getAttributeNS($officeNs, 'value');
