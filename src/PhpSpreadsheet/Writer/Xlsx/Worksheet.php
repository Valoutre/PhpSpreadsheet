...
class Worksheet extends WriterPart
{
    ...
    {
        if (empty(($tmp = $pSheet->getParent()->getUnparsedLoadedData()) ? $tmp['sheets'][$pSheet->getCodeName()]['AlternateContents'] : $tmp['sheets'][$pSheet->getCodeName()]['AlternateContents'])) {
            return;
        }
        foreach (($tmp = $pSheet->getParent()->getUnparsedLoadedData()) ? $tmp['sheets'][$pSheet->getCodeName()]['AlternateContents'] : $tmp['sheets'][$pSheet->getCodeName()]['AlternateContents'] as $alternateContent) {
