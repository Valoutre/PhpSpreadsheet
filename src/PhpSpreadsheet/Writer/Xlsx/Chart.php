...
class Chart extends WriterPart
{
    ...
    private function writeValueAxis($objWriter, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, Axis $xAxis, GridLines $majorGridlines, GridLines $minorGridlines)
    {
        ...
        if ($majorGridlines->getLineColorProperty('value') !== null) {
            ...
            if ($majorGridlines->getLineStyleProperty(array('arrow', 'head', 'type')) !== null) {
            ...
            if ($majorGridlines->getLineStyleProperty(array('arrow', 'end', 'type')) !== null) {
        ...
        if ($majorGridlines->getShadowProperty('presets') !== null) {
            ...
            if ($majorGridlines->getShadowProperty(array('size', 'sx')) !== null) {
                $objWriter->writeAttribute('sx', $majorGridlines->getShadowProperty(array('size', 'sx')));
            }
            if ($majorGridlines->getShadowProperty(array('size', 'sy')) !== null) {
                $objWriter->writeAttribute('sy', $majorGridlines->getShadowProperty(array('size', 'sy')));
            }
            if ($majorGridlines->getShadowProperty(array('size', 'kx')) !== null) {
        ...
        if ($minorGridlines->getObjectState()) {
            ...
            if ($minorGridlines->getLineColorProperty('value') !== null) {
                ...
                if ($minorGridlines->getLineStyleProperty(array('arrow', 'head', 'type')) !== null) {
                    $objWriter->startElement('a:headEnd');
                ...
                if ($minorGridlines->getLineStyleProperty(array('arrow', 'end', 'type')) !== null) {
                    $objWriter->startElement('a:tailEnd');
            ...
            if ($minorGridlines->getShadowProperty('presets') !== null) {
                ...
                if ($minorGridlines->getShadowProperty(array('size', 'sx')) !== null) {
                    $objWriter->writeAttribute('sx', $minorGridlines->getShadowProperty(array('size', 'sx')));
                }
                if ($minorGridlines->getShadowProperty(array('size', 'sy')) !== null) {
                    $objWriter->writeAttribute('sy', $minorGridlines->getShadowProperty(array('size', 'sy')));
                }
                if ($minorGridlines->getShadowProperty(array('size', 'kx')) !== null) {
        ...
        if ($xAxis->getLineStyleProperty(array('arrow', 'head', 'type')) !== null) {
            $objWriter->startElement('a:headEnd');
        ...
        if ($xAxis->getLineStyleProperty(array('arrow', 'end', 'type')) !== null) {
            $objWriter->startElement('a:tailEnd');
        ...
        if ($xAxis->getShadowProperty('presets') !== null) {
            ...
            if ($xAxis->getShadowProperty(array('size', 'sx')) !== null) {
                $objWriter->writeAttribute('sx', $xAxis->getShadowProperty(array('size', 'sx')));
            }
            if ($xAxis->getShadowProperty(array('size', 'sy')) !== null) {
                $objWriter->writeAttribute('sy', $xAxis->getShadowProperty(array('size', 'sy')));
            }
            if ($xAxis->getShadowProperty(array('size', 'kx')) !== null) {
